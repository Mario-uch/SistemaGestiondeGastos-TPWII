...
<h2 class="titulo">Gestion de gastos</h2>
	...
	<form method="POST" action="./insertarGastos" class="formulario" style="background-color:white;">
	
	<label class="label" for="monto"> Monto del Gasto: </label>
	<input type="text" class="input" name="monto" id="monto" required>
	<br/>
...
<form method="POST" action="./tabla" class="formulario2">

<label class="label" for="monto"> Monto del Gasto: </label>
	<input type="text" class="input" name="monto" id="monto" required>
	<br/>
	<button class="submit" style="background-color:#A82E1E;">Buscar</button>
</form>
