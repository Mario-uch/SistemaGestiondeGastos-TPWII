<div class="wrapper fadeInDown">
  <div id="formContent">
    ...
    <!-- Login Form -->
    <form method="POST" action="./Home/insertar">
      <input type="text" id="nombre" class="fadeIn second" name="nombre" placeholder="usuario">
    ...
    <!-- Remind Passowrd -->
    <div id="formFooter">
      <a class="underlineHover" href="http://localhost/GestionDeGastos">Registrase</a>
    </div>
